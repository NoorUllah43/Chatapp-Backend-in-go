...
const Login = () => {
    ...
    return (
        <div className='flex items-center justify-between '>
            <div className='hidden md:flex flex-col items-center justify-center gap-2 md:w-1/2  h-screen bg-gradient-to-b from-purple-500 to-blue-500 text-white '>
                <motion.div animate={{
                    y: [0, -40, 0],
                    rotate: [0, -10, 0],
                }}
            ...
            <div className="flex items-center justify-center md:w-1/2 w-full h-screen">
                <div className="flex flex-col items-center justify-center gap-2 h-full w-[80%] md:w-[70%] ">
